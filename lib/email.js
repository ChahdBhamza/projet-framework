...
export async function sendVerificationEmail(email, token) {
  ...
  return sendEmail({
    to: email,
    subject: "Verify Your Email - Dietopia",
    html,
  });
}
...
export async function sendPasswordResetEmail(email, token) {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>We received a request to reset your password for your Dietopiat account.</p>
            <p style="text-align: center;">
          ...
          <div class="footer">
            <p>© 2025 Dietopia. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
  ...
  return sendEmail({
    to: email,
    subject: "Reset Your Password - Dietopia",
    html,
  });
}
